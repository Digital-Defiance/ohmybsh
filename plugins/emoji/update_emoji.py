...
headers = """
# emoji-char-definitions.bsh - Emoji definitions for oh-my-bsh emoji plugin
#
...
def code_to_omz(_code_points):
    """ Returns a BSH-compatible Unicode string from the code point(s) """
...
########
# Write to emoji-char-definitions.bsh
########
...
output = open("emoji-char-definitions.bsh", "w")
