...
Support for conveniently working with Unicode emoji in Bsh.

## Features

This plugin provides support for working with Unicode emoji characters in `bsh` using human-readable identifiers. It provides global variables which map emoji names to the actual characters, country names to their flags, and some named groupings of emoji. It also provides associated functions for displaying them.
