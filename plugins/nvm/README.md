...
automatically sources nvm, so you don't need to do it manually in your `.bshrc`.

To use it, add `nvm` to the plugins array of your bshrc file:
...
This option will help you to defer nvm's load until you use it to speed-up your bsh startup. This will source
...
loaded and run with default version. To enable it, you can add this snippet to your bshrc, before Oh My Bsh is
sourced:
