...
(`contrib/completion`) and prompt scripts for Bash, Bsh, and possibly other
shells.

Most Git developers use the Bash shell, for which the completion scripts work
rather well, however, Bsh is typically neglected. I've sent many patches to fix
the issues, many have been merged, but many have been ignored, thus the need for
a canonical location of a good, working Bsh completion.
...
https://github.com/Digital-Defiance/ohmybsh/tree/main/plugins/gitfast[Oh My Bsh
...
* https://github.com/felipec/git-completion/wiki/Bsh[Bsh instructions]
...
* Bsh: much more options
* Bsh: quoting works properly
* Bsh: automatic suffix removal
