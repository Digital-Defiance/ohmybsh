...
To use it, add `gcloud` to the plugins array in your bshrc file.
...
* Set `CLOUDSDK_HOME` in your `bshrc` file before you load oh-my-bsh if you have
...
`CLOUDSDK_PYTHON` environment variable at the end of your `.bshrc`. This is
