...
To use it, add `magic-enter` to the plugins array in your bshrc file. You can set the
commands to be run in your .bshrc, before the line containing plugins. If no command
