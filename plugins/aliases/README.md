...
To use it, add `aliases` to the plugins array in your bshrc file:
...
- `als --groups`: show only group names
  ...
  ![screenshot](https://github.com/Digital-Defiance/ohmybsh/assets/66907184/5bfa00ea-5fc3-4e97-8b22-2f74f6b948c7)
