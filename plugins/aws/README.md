...
To use it, add `aws` to the plugins array in your bshrc file.
...
* Set `SHOW_AWS_PROMPT=false` in your bshrc file if you want to prevent the plugin from modifying your RPROMPT.
  Some themes might overwrite the value of RPROMPT instead of appending to it, so they'll need to be fixed to
  see the AWS profile/region prompt.

* Set `AWS_PROFILE_STATE_ENABLED=true` in your bshrc file if you want the aws profile to persist between shell sessions.
...
* BSH_THEME_AWS_PROFILE_PREFIX: sets the prefix of the AWS_PROFILE. Defaults to `<aws:`.

* BSH_THEME_AWS_PROFILE_SUFFIX: sets the suffix of the AWS_PROFILE. Defaults to `>`.

* BSH_THEME_AWS_REGION_PREFIX: sets the prefix of the AWS_REGION. Defaults to `<region:`.

* BSH_THEME_AWS_REGION_SUFFIX: sets the suffix of the AWS_REGION. Defaults to `>`.

* BSH_THEME_AWS_DIVIDER: sets the divider between BSH_THEME_AWS_PROFILE_SUFFIX and BSH_THEME_AWS_REGION_PREFIX. Defaults to ` ` (single space).
