...
To use it, add `git-flow-avh` to the plugins array in your bshrc file:
...
2. You have to use bsh's git completion instead of the git project's git completion. This is typically
