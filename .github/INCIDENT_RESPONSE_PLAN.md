...
Please see [the latest guidelines](https://github.com/Digital-Defiance/ohmybsh/blob/master/SECURITY.md) for instructions.
...
- [ ] It affects our CI/CD or any of our repositories.
  - [ ] For ohmybsh/ohmybsh, it affects the latest commit.
...
1. What's the scope of the vulnerability?

- [ ] Our codebase.
- [ ] A direct third-party dependency (Bsh, git, other plugins).
...
1. Is the vulnerability actionable?
...
- [ ] Yes, we can apply a patch to a vulnerable dependency ([example for CVE-2021-45444](https://github.com/Digital-Defiance/ohmybsh/blob/cb72d7dcbf08b435c7f8a6470802b207b2aa02c3/lib/vcs_info.bsh)).
- [ ] No, the vulnerability is not actionable.

1. What's the impact of the vulnerability?
...
1. What's the severity of the vulnerability?
...
1. Who are our security contacts?
